...
<body class="sidebar-mini skin-blue-light text-sm" data-gr-c-s-loaded="true"
    style="height: auto; min-height: 100%; font-family: 'SolaimanLipi', sans-serif;">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a target="_blank" href="https://drive.google.com/file/d/1KglRYIPzHDPzEW_ZxnDTfkyVgHzpeelC/view"
                        target="_blank" class="nav-link">ভিডিও টিউটোরিয়াল</a>
                </li>
            </ul>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav nav-treeview" style="display: none;">
                                        <li class="nav-item">
                                            <a href="{{ route('admin.faculty-list') }}" class="nav-link">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                ডেভেলপড বাই: <a href="https://iconbangla.net" target="_blank" rel="noopener noreferrer">আইকন
                    বাংলা</a>
            </div>
            <!-- Default to the left -->
            <strong>কপিরাইট &copy; ২০২৩ <a href="">ডাইনামিক স্কুল ম্যানেজমেন্ট সিস্টেম</a></strong> সর্বস্বত্ব
            সংরক্ষিত
        </footer>
    </div>
    <!-- ./wrapper -->
