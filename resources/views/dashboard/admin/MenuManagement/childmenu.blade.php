              ...
              <table class="table table-hover table-condensed" id="menu-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $childmenu->faculty_department }}</td>
            ...
            <div class="modal-body">
              <form action="{{ route('admin.addChildMenu') }}" enctype="multipart/form-data" files="true" method="post" autocomplete="off" id="add-childmenu-form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="childmenu_name">চাইল্ড মেনুর নাম</label>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="child_menu_status">স্ট্যাটাস</label>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '#editChildMenuBtn', function() {
      ...
      $.post("{{ route('admin.getChildMenuDetails') }}", {
        childmenu_id: childmenu_id
      }, function(data) {
