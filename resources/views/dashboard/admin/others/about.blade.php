    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                                    ...
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            ...
                                            <button class="btn btn-flat btn-success" data-toggle="modal"
                                                data-target="#addabouts"><i class="fas fa-plus-square mr-1"></i> বাণী যোগ
                                                করুন</button>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($abouts as $about)
                                            <tr>
                                                ...
                                                <td>
                                                    <img height="50"
                                                        src="{{ asset('storage/img/about_img/' . $about->upload) }}"
                                                        alt="">
                                                </td>
                                                <td
                                                    class="{{ $about->about_status == 1 ? 'text-success' : 'text-danger' }} font-weight-bold">
                                                    {{ $about->about_status == 1 ? 'একটিভ' : 'একটিভ নয়' }}
                                                </td>
                                                <td>
                                                    <span data-id="{{ $about->id }}" id="editaboutBtn"><i
                                                            class="fas fa-edit text-warning"></i></span> &nbsp;
                                                    <span data-id="{{ $about->id }}" id="deleteaboutBtn"><i
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.addAbout') }}" enctype="multipart/form-data" files="true"
                                    method="post" autocomplete="off" id="add-about-form">
                                    @csrf
                ...
                {{-- Edit Modal --}}
                <div class="modal fade editabout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.updateAboutDetails') }}" enctype="multipart/form-data"
                                    files="true" method="post" autocomplete="off" id="update-about-form">
                                    @csrf
