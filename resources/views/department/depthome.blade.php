                ...
                @if ($about)
                    <div class="row content">
                        <div class="col-lg-6" data-aos="fade-right">
                            <img src="{{ asset('storage/img/about_img/' . $about->upload) }}"
                                class="principal-image float-left" alt="" style="max-width: 100%; height: auto;">
                            <h4>{{ $about->name }}</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-5 mb-lg-0" data-aos="fade-right"
                            ...
                            <ul class="nav nav-tabs flex-column">
                                ...
                                @foreach ($provider_ntcs->unique('type_name') as $ntcs)
                                    <li class="nav-item">
                                        <a class="nav-link {{ $index === 1 ? 'active show' : '' }}" data-bs-toggle="tab"
                                            href="#tab-{{ $index }}">
                        ...
                        <div class="col-lg-8 ml-auto" data-aos="fade-left" data-aos-delay="100">
                            <div class="tab-content">
                                ...
                                @foreach ($provider_ntcs->unique('type_name') as $ntcs)
                                    <div class="tab-pane {{ $tabIndex === 1 ? 'active show' : '' }}"
                                        id="tab-{{ $tabIndex }}">
                                                    ...
                                                    @if ($event->type_name === $ntcs->type_name)
                                                        @if ($count < 10)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('deptnotice', ['faculty' => $currentFaculty, 'dept' => $currentDept, 'noticeslug' => $event->url]) }}"
                                            ...
                                            @if ($count > 8)
                                                <tr>
                                                    <td colspan="3" class="text-center">
                                                        <a href="{{ route('allnotice', ['cat' => $ntcs->type_name]) }}"
                                                            class="btn btn-success show-all-button btn-sm">
                                                            সকল নোটিশ
                                                        </a>
                                                    </td>
                                                </tr>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up">
                            <div class="member-img">
                                <img src="{{ asset('storage/img/teacher_img/' . $teacher->teacher_image) }}"
                                    class="img-fluid" alt="">
                                <div class="social">
                                ...
                                <ul class="menus">
                                    ...
                                    @foreach ($important_links as $link)
                                        <li class="list-group-item"><a
                                                href="{{ $link->link }}">{{ $link->link_name }}</a></li>
                                    @endforeach
            ...
            <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-1.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-2.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-3.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-4.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-5.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-6.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-7.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="{{ asset('dept/assets/') }}/img/clients/client-8.png" class="img-fluid"
                            alt="">
                    </div>
                </div>
